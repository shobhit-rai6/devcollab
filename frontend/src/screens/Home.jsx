        ...
        <>
            <style>{`
                ...
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .home-logo { display: flex; align-items: center; gap: 0.75rem; }
                ...
                .hero-title {
                    ...
                    color: #f0f1f8; margin-bottom: 0.75rem;
                }
                ...
                .hero-sub { font-size: 0.95rem; color: #64748b; font-weight: 300; max-width: 460px; }
                ...
                .stat-divider { width: 1px; height: 30px; background: rgba(255,255,255,0.07); }
                ...
                .new-project-card:hover::before { opacity: 1; }
                ...
                .card-folder-icon {
                    ...
                    border-radius: 9px;
                    display: flex; align-items: center; justify-content: center;
                    font-size: 0.95rem; color: #818cf8;
                }
                ...
                .card-name {
                    ...
                    color: #e8e9f0; letter-spacing: -0.01em; line-height: 1.3;
                }

                .card-date { font-size: 0.68rem; color: #475569; margin-top: 0.2rem; }
                ...
                .modal-title {
                    font-family: 'Syne', sans-serif;
                    font-size: 1.2rem; font-weight: 700; color: #e8e9f0;
                }
                ...
                .modal-close {
                    ...
                    display: flex; align-items: center; justify-content: center;
                    color: #64748b; font-size: 1rem; transition: all 0.15s ease;
                }

                .modal-close:hover { background: rgba(255,255,255,0.12); color: #e8e9f0; }
                ...
                .empty-state {
                    grid-column: 1 / -1;
                    padding: 4rem 0; text-align: center; color: #334155;
                }
            ...
            <div className="home-root">
                <div className="home-container">
                    ...
                    <div className="projects-grid">
                        <button onClick={() => setIsModalOpen(true)} className="new-project-card">
                                    ...
                                    <div>
                                        ...
                                        {project.updatedAt && (
                                            <div className="card-date">
                                                Updated {new Date(project.updatedAt).toLocaleDateString('en-IN', {
                    ...
                    <div className="modal-box">
                        ...
                        <form onSubmit={createProject}>
                            ...
                            <div className="modal-actions">
                                <button type="button" className="btn-cancel" onClick={() => { setIsModalOpen(false); setProjectName('') }}>
                                    Cancel
                                </button>
